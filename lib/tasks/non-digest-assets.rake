...
Rake::Task["assets:precompile"].enhance do
  Rake::Task["final_project_quiz:create_non_digest_assets"].invoke
end
 
namespace :final_project_quiz do 
  ...
  task :create_non_digest_assets => :"assets:environment"  do    
    ...
    manifest_data["assets"].each do |logical_path, digested_path|
      ...
      if FinalProjectQuiz::Application.config.non_digest_named_assets.any? {|testpath| logical_pathname.fnmatch?(testpath, File::FNM_PATHNAME) }
